...
$workingDir = 'D:\P2GJOB\cyberark\scripts'
$sourceFileDir = 'D:\P2GJOB\cyberark\Results'
...
#Write-Host "lastRunTimeTask1: (Get-Date $lastRunTimeTask1).ToString("yyyy-MM-dd")" # debug script
